...
import com.zwb.thirdpartydemo.adapter.MyRecylerViewGlideAdapter;

import java.util.ArrayList;
import java.util.List;

public class GlideRecylerViewActivity extends AppCompatActivity {

    private TextView tvTitle;
    private ImageView back;
    private RecyclerView recyclerView;
    private List<String> list;
    private MyRecylerViewGlideAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_glide_recyler_view);
        initData();
        initView();
    }
    ...
    private void initView() {
        ...
        tvTitle.setText("RecyclerView-glide");
        ...
        adapter = new MyRecylerViewGlideAdapter(this,list);
