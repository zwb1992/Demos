...
public class YDRefreshScrollingUtil {

    private YDRefreshScrollingUtil() {
    }
    ...
    public static boolean isStickyNavLayoutToTop(YDStickyNavLayout stickyNavLayout) {
    ...
    public static boolean isAbsListViewToBottom(AbsListView absListView) {
        if (absListView != null && absListView.getAdapter() != null && absListView.getChildCount() > 0 && absListView.getLastVisiblePosition() == absListView.getAdapter().getCount() - 1) {
            ...
            YDStickyNavLayout stickyNavLayout = getStickyNavLayout(absListView);
        ...
        if (recyclerView != null) {
            ...
            if (manager instanceof LinearLayoutManager) {
                ...
                if (layoutManager.findLastCompletelyVisibleItemPosition() == layoutManager.getItemCount() - 1) {
                    YDStickyNavLayout stickyNavLayout = getStickyNavLayout(recyclerView);
                    if (stickyNavLayout != null) {
    ...
    public static YDStickyNavLayout getStickyNavLayout(View view) {
        ViewParent viewParent = view.getParent();
        while (viewParent != null) {
            if (viewParent instanceof YDStickyNavLayout) {
                return (YDStickyNavLayout) viewParent;
            }
