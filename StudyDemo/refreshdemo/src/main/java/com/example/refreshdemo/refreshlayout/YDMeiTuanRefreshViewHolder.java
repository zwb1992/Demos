...
public class YDMeiTuanRefreshViewHolder extends YDRefreshViewHolder {
    private YDMeiTuanRefreshView mMeiTuanRefreshView;
     ...
     */
    public YDMeiTuanRefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
    ...
    public View getRefreshHeaderView() {
        if (mRefreshHeaderView == null) {
            ...
            mMeiTuanRefreshView = (YDMeiTuanRefreshView) mRefreshHeaderView.findViewById(R.id.meiTuanView);
