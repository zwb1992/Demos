 ...
 * 描述:黏性下拉刷新控件
 */
public class YDStickinessRefreshView extends View {
    private static final String TAG = YDStickinessRefreshView.class.getSimpleName();
    private YDStickinessRefreshViewHolder mStickinessRefreshViewHolder;
    ...
    public YDStickinessRefreshView(Context context) {
        this(context, null);
    }

    public YDStickinessRefreshView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public YDStickinessRefreshView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initSize() {
        mEdge = YDRefreshLayout.dp2px(getContext(), 5);
        mRotateDrawableSize = YDRefreshLayout.dp2px(getContext(), 30);
...
//            mPath.quadTo(mTopBound.left + mTopSize / 8, mTopBound.bottom, mTopBound.left, mTopBound.bottom - mTopSize / 2);
    ...
    public void setStickinessRefreshViewHolder(YDStickinessRefreshViewHolder stickinessRefreshViewHolder) {
