...
public class YDStickyNavLayout extends LinearLayout {
    ...
    public YDStickyNavLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public boolean isContentViewToTop() {
        ...
        if (YDRefreshScrollingUtil.isScrollViewOrWebViewToTop(mDirectWebView)) {
            return true;
        }

        if (YDRefreshScrollingUtil.isScrollViewOrWebViewToTop(mDirectScrollView)) {
            return true;
        }

        if (YDRefreshScrollingUtil.isAbsListViewToTop(mDirectAbsListView)) {
            return true;
        }

        if (YDRefreshScrollingUtil.isRecyclerViewToTop(mDirectRecyclerView)) {
            return true;
        }
    ...
    private boolean isViewPagerContentViewToTop() {
        ...
        if (YDRefreshScrollingUtil.isScrollViewOrWebViewToTop(mNestedWebView)) {
            return true;
        }

        if (YDRefreshScrollingUtil.isScrollViewOrWebViewToTop(mNestedScrollView)) {
            return true;
        }

        if (YDRefreshScrollingUtil.isAbsListViewToTop(mNestedAbsListView)) {
            return true;
        }

        if (YDRefreshScrollingUtil.isRecyclerViewToTop(mNestedRecyclerView)) {
            return true;
        }
    ...
    public void setRefreshLayout(YDRefreshLayout refreshLayout) {
    ...
    public boolean shouldHandleLoadingMore() {
        ...
        if (YDRefreshScrollingUtil.isWebViewToBottom(mDirectWebView)) {
            return true;
        }

        if (YDRefreshScrollingUtil.isScrollViewToBottom(mDirectScrollView)) {
            return true;
        }
        ...
        if (mDirectViewPager != null) {
            ...
            if (YDRefreshScrollingUtil.isWebViewToBottom(mNestedWebView)) {
                return true;
            }

            if (YDRefreshScrollingUtil.isScrollViewToBottom(mNestedScrollView)) {
                return true;
            }
    ...
    public void scrollToBottom() {
        YDRefreshScrollingUtil.scrollToBottom(mDirectScrollView);
        YDRefreshScrollingUtil.scrollToBottom(mDirectRecyclerView);
        YDRefreshScrollingUtil.scrollToBottom(mDirectAbsListView);

        if (mDirectViewPager != null) {
            if (mNestedContentView == null) {
                regetNestedContentView();
            }
            YDRefreshScrollingUtil.scrollToBottom(mNestedScrollView);
            YDRefreshScrollingUtil.scrollToBottom(mNestedRecyclerView);
            YDRefreshScrollingUtil.scrollToBottom(mNestedAbsListView);
        }
    }
}