...
import com.zwb.viewpagerindictorlibrary.R;
...
public class PagerSlidingTabStrip extends HorizontalScrollView implements OnPageChangeListener {
    ...
    public void updateTab(int index,int unReadCount) {
        ...
        if (unReadCount > 0) {
            unreadLbl.setVisibility(View.VISIBLE);
            indicatorView.setVisibility(View.VISIBLE);
            if (unReadCount < 100) {
                unreadLbl.setText(unReadCount + "");
            } else {
                unreadLbl.setText("99+");
            }
        } else {
